...
"Find the Bot" is a multiplayer social deduction game built with Blazor (.NET 10). Players join a chat room and interact to identify which participants are bots controlled by AI. The bots use LLMs (Large Language Models, specifically Groq/OpenAI) to mimic human behavior, making the challenge engaging and unpredictable.
...
- **Architecture:** .NET 10 Blazor Server.
